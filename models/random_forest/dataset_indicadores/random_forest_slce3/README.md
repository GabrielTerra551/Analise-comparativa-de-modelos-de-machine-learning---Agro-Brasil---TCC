# Random Forest - SLCE3 (Dataset Indicadores)
...
- Dataset: datasets_indicadores/classificacao/SLCE3_tratado.csv
...
- matriz_confusao_slce3_indicadores.png
- curva_roc_slce3_indicadores.png
- comparacao_metricas_slce3_indicadores.png
- evolucao_metricas_slce3_indicadores.png
- metricas_classe_alta_slce3_indicadores.png
